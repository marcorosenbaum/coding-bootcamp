import { todos, readTodosFromLocalStorage } from "./localStorage.js";
...
function deleteDoneTodos(aaa) {
  todos = aaa.filter((todo) => todo.done === false);
  saveTodosToLocalStorage();
  renderTodos();
}
